...
namespace Stride.Core.Mathematics
{
    ...
    public partial struct Color : IEquatable<Color>
    {
        ...
        public static Color CriticalDamp(Color cur, Color targ, ref Color velocity, float smoothTime, float dt)
        {
            var rgbV = velocity.ToVector3();
            var aV = (float)velocity.A;
            var rgb = Vector3.CriticalDamp(cur.ToVector3(), targ.ToVector3(), ref rgbV, smoothTime, dt);
            var a = MathUtil.CriticalDamp(cur.A, targ.A, ref aV, smoothTime, dt);

...
namespace Stride.Physics.Bepu
{
    ...
    public sealed class BepuRigidbodyComponent : BepuPhysicsComponent
    {
        ...
        private static void PrepareDelegates()
        {
            ...
            {
                rb.InternalBody.Collidable.MinimumSpeculativeMargin = rb.bodyDescription.Collidable.MinimumSpeculativeMargin;
                rb.InternalBody.Collidable.MaximumSpeculativeMargin = rb.bodyDescription.Collidable.MaximumSpeculativeMargin;
        ...
        private void UpdateInertia(bool skipset = false)
        {
            ...
            {
                bodyDescription.LocalInertia =  ics.ComputeInertia(mass);
            ...
            {
                if (IsOpen)
                    bodyDescription.LocalInertia = m.ComputeOpenInertia(mass);
                else
                    bodyDescription.LocalInertia = m.ComputeClosedInertia(mass);
        ...
        {
            get => bodyDescription.Collidable.MaximumSpeculativeMargin;
            set
            {
                if (bodyDescription.Collidable.MaximumSpeculativeMargin == value) return;

                bodyDescription.Collidable.MaximumSpeculativeMargin = value;
        ...
        {
            get => bodyDescription.Collidable.MinimumSpeculativeMargin;
            set
            {
                if (bodyDescription.Collidable.MinimumSpeculativeMargin == value) return;

                bodyDescription.Collidable.MinimumSpeculativeMargin = value;

...
{
    public class BepuPhysicsSystem : GameSystem, IPhysicsSystem
    {
      ...
      //  public static float MaxTickDuration = 1f / 120f;
        ...
        public override void Initialize()
        {
         ...
         //   MaxTickDuration = physicsConfiguration.MaxTickDuration;
            EntityManager.onlyBepu = physicsConfiguration.OnlyUseBepu;
        ...
        protected override void Destroy()
        {
            ...
            {
                scene.BulletSimulation?.Dispose();
        ...
        public Bullet2Simulation CreateBullet(PhysicsProcessor sceneProcessor, PhysicsEngineFlags flags = PhysicsEngineFlags.None)
        {
            ...
            scenes.Add(scene);
            return scene.BulletSimulation;
        }

        public object CreateBepu(PhysicsProcessor sceneProcessor, PhysicsEngineFlags flags = PhysicsEngineFlags.None)
        {
            var scene = new PhysicsScene
            {
                Processor = sceneProcessor,
                BulletSimulation = null,
                BepuSimulation = new BepuSimulation(physicsConfiguration)
            };
            scenes.Add(scene);
            return scene.BepuSimulation;
        }
        ...
        public bool HasSimulation<T>()
        {
            ...
            {
                if (scenes[i].BulletSimulation is T s && s != null) return true;
        ...
        private void RunPhysicsSimulation(float time)
        {
            ...
            for (int i = 0; i < scenes.Count; i++)
            {
                ...
                if (physicsScene.BulletSimulation != null)
                {
                    ...
                    if (Bullet2Simulation.DisableSimulation == false)
                    {
                        ...
                        //simulate physics
                        physicsScene.BulletSimulation.Simulate(time);
                        ...
                        physicsScene.BulletSimulation.BeginContactTesting();

                        //handle frame contacts
                        physicsScene.Processor.UpdateContacts();

                        //This is the heavy contact logic
                        physicsScene.BulletSimulation.EndContactTesting();

                        //send contact events
                        physicsScene.BulletSimulation.SendEvents();
                        ...
                        */
                        ...
                        //handle frame contacts
                        physicsScene.BulletSimulation.UpdateContacts();
